...
- Branches
  ...
  - master: This is the main branch of the project. https://dreamspace.academy/
  - dev: Implement new features and debug. The development processes are done inside this branch. https://dev.dreamspace.academy

- Git commands

  - Step 01: Clone the repository

    - git clone https://github.com/dreamspace-academy/dreamspace.foundation.git
...
<p align="center">
<img src="./assets/img/web-screen.png">
</p>
